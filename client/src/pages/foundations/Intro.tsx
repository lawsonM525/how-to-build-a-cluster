      ...
      <section className="space-y-6">
        ...
        <div className="bg-bg-secondary/20 p-6 rounded-lg">
          ...
          <p className="text-sm text-primary/80">
            In 1965, Gordon Moore (who later co-founded Intel) made a prediction that changed computing forever. In his paper "Cramming More Components onto Integrated Circuits," he noticed that the number of components on chips was doubling every year, and predicted this trend would continue.
          </p>
          <p className="text-sm text-primary/80 mt-2">
            Moore wrote: <em>"Integrated circuits will lead to such wonders as home computers, automatic controls for automobiles, and personal portable communications equipment."</em> Remember, this was in 1965 when computers filled entire rooms!
          </p>
          <p className="text-sm text-primary/80 mt-2">
            He even predicted that by 1975, we could fit 65,000 components on a single silicon chip. People thought he was wildly optimistic, but he was right. Each new processor generation became significantly faster than the last through sheer transistor density.
          </p>
          <p className="text-sm text-primary/80 mt-2">
            But by the early 2000s, we began hitting fundamental physical limits—heat dissipation (Moore actually predicted this challenge too!), quantum effects, and the speed of light itself. As Moore's paper noted: <em>"Will it be possible to remove the heat generated by tens of thousands of components in a single silicon chip?"</em>
          </p>
          <p className="text-sm text-primary/80 mt-2">
            The industry's answer? Stop trying to make single processors exponentially faster and instead use <strong>multi-core</strong> and <strong>distributed systems</strong> to keep scaling up. This is exactly what Moore suggested might happen: <em>"It may prove to be more economical to build large systems out of smaller functions."</em>
          </p>
          <p className="text-sm text-primary/80 mt-2">
          ...
          <div className="mt-4">
            <a 
              href="https://hasler.ece.gatech.edu/Published_papers/Technology_overview/gordon_moore_1965_article.pdf" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-sm underline decoration-primary/30 hover:decoration-primary"
            >
              Read the original paper (1965)
            </a>
          </div>
        </div>
